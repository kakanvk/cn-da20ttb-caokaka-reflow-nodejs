...
function UpdateBackground() {
    ...
    const handleUpdateById = (newData) => {
        axios.put(`http://localhost:3005/api/backgrounds/${id}`, newData, {
    ...
    const fecthUserData = async () => {
        setSpinning(true);
        axios.get(`http://localhost:3005/api/backgrounds/${id}`, {
            withCredentials: true
        })
            .then(response => {
                console.log(response.data);
    ...
    return (
        <Flex className="UpdateBackground" vertical gap={20}>
            {contextHolder}
            ...
            <Breadcrumb
                items={[
                    ...
                    {
                        title: <Link to="/admin/backgrounds">Quản lý hình nền</Link>,
                    },
                    {
                        title: 'Cập nhật',
                    },
            ...
            />
            {
                ...
                <Form
                    ...
                    initialValues={{
                        ...
                        premium_only: userData.premium_only
                    }}
                    onFinish={onFinish}
                    layout="vertical"
                >
                    <Form.Item
                        ...
                        label="Tên hình nền"
                    >
                        <Input placeholder="Tên hình nền" allowClear size="large" />
                    </Form.Item>
                    <Form.Item
                        name="premium_only"
                        label="Loại hình nền"
                    >
                        <Select placeholder="Loại hình nền" prefix={<FireOutlined className="site-form-item-icon" />} size="large" allowClear>
